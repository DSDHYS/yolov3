...
yolo = mAP_Yolo()
image_ids = open('test_relative.txt').read().strip().split()#图片名称txt文档
...
for image_id in tqdm(image_ids):
    image_path = "E:\document\syn\data\graduation-project\yolo3-pytorch-master\VOCdevkit\VOC2007\JPEGImages\\"+image_id+".jpg"
