...
image_ids = open('train_relative.txt').read().strip().split()#图片打开路径
...
for image_id in image_ids:
    with open("./input/ground-truth/"+image_id+".txt", "w") as new_f:
        root = ET.parse("E:\document\syn\data\graduation-project\yolo3-pytorch-master\VOCdevkit\VOC2007\Annotations\\"+image_id+".xml").getroot()#标签所在路径
